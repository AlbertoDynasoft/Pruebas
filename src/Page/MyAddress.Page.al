page 51150 MyAddress
{
    ...
    actions
    {
        area(Processing)
        {
            action(WhatsTheAddress)
            {
                ...
                trigger OnAction()
                var
                    iAddressProvider: Interface "AMM IAddressProvider";
                begin
    ...
    local procedure AddressproviderFactory(var iAddressProvider: Interface "AMM IAddressProvider")
    var
        CompanyAddressProvider: Codeunit "AMM CompanyAddressProvider";
        PrivateAddressProvider: Codeunit "AMM PrivateAddressProvider";
    begin
